...
namespace MITD.Fuel.Application.Facade.Mappers
{
    public class OrderToDtoMapper : BaseFacadeMapper<Order, OrderDto>, IOrderToDtoMapper
    {
        ...
        public OrderDto MapToModelWithAllIncludes(Order order)
        {
...
//            }
            ...
            {
                var list = OrderItemToDtoMapper.MapEntityToDto(order.OrderItems);
                dto.OrderItems = new ObservableCollection<OrderItemDto>(list);
            }
            return orderDto;
        }

        public IEnumerable<OrderDto> MapToModelWithAllIncludes(IEnumerable<Order> entities)
        {
