...
namespace MITD.Fuel.Data.EF.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MITD.Fuel.Data.EF.Context.DataContainer>
    {
        ...
        private void insertScraps(DataContainer context, long userId)
        {
            ...
            int i = 1;
            foreach (var detail in context.Scraps)
            {
        ...
        private static void insertCharterIn(DataContainer context, long userId)
        {
            ...
            var tankId = context.Tanks.First(t => t.VesselInInventoryId == vesselInCompanyId).Id;
            ...
            //id chartererId ownerId vesselInCompanyId CurrencyId,
